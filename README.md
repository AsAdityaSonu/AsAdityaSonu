...
<h4>🔭 <strong>Building </strong>
  ...
  — a learning platform for coding, AI, and engineering minds 🚀
</h4>

<!-- 
  <h3>🌱 <strong>Learning:</strong></h3> 
  <p>ML, DL, IoT, and cloud computing</p>

  <h3>👯 <strong>Looking to collaborate on:</strong></h3> 
  <p>ML/DL, IoT, and Next.js projects</p>

  <h3>🤝 <strong>Seeking help with:</strong></h3> 
  <p>IoT optimizations & cloud scalability</p>

  <h3>💬 <strong>Ask me about:</strong></h3> 
  <p>ML, React, Next.js, Edge Computing, or my projects (<em>Irrigo Twin, Parking Scan, Sweat Set</em>)</p> -->
</div>
